...
% Main variables
%--------------------------------------------------------------------------------------
\newcommand{\vikszerzo}{RÛbert L·szlÛ DÛczi}
...
\pagestyle{plain}
\setlength{\parindent}{0pt} % √°ttekinthet√µbb, angol nyelv√ª dokumentumokban jellemz√µ
\setlength{\parskip}{8pt plus 3pt minus 3pt} % √°ttekinthet√µbb, angol nyelv√ª dokumentumokban jellemz√µ
%\setlength{\parindent}{12pt} % magyar nyelv√ª dokumentumokban jellemz√µ
%\setlength{\parskip}{0pt}    % magyar nyelv√ª dokumentumokban jellemz√µ
