...
import hu.bme.mit.incquery.localsearch.cpp.generator.LocalSearchCppGenerator
import hu.bme.mit.incquery.localsearch.cpp.generator.internal.LocalsearchGeneratorOutputProvider
import hu.bme.mit.incquery.localsearch.cpp.generator.serializer.DefaultSerializer
import hu.bme.mit.incquery.localsearch.cpp.ui.XTextFileAccessor
...
class GeneratorHandler {
	...
	def generate(ExecutionEvent event, Class<? extends LocalsearchGeneratorOutputProvider> generatorClass) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			val outputProvider = generator.generate(fileName, xtextResourceSet, pQueries)
