...
#ifndef LOCALSEARCH_OPERATIONS_CHECK_ASSOCIATIONCHECK_H_
#define LOCALSEARCH_OPERATIONS_CHECK_ASSOCIATIONCHECK_H_
...
template<typename SrcType, typename TrgType, typename Collection, typename Member, typename MatchingFrame>
inline MultiAssociationCheck<SrcType, TrgType, Collection, Member, MatchingFrame>::MultiAssociationCheck(SrcGetter getSrc,
        TrgGetter getTrg, Navigator navigate) :
        _src(getSrc), _trg(getTrg), _navigate(navigate) {
}

template<typename SrcType, typename TrgType, typename Collection, typename Member, typename MatchingFrame>
inline bool MultiAssociationCheck<SrcType, TrgType, Collection, Member, MatchingFrame>::check(MatchingFrame& frame,
        const Matcher::ISearchContext&) {
    SrcType src = frame.*_src;
    TrgType trg = frame.*_trg;;
...
#endif /* LOCALSEARCH_OPERATIONS_CHECK_ASSOCIATIONCHECK_H_ */
