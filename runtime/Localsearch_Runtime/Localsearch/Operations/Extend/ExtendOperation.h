...
#ifndef LOCALSEARCH_OPERATIONS_EXTEND_EXTENDOPERATION_H_
#define LOCALSEARCH_OPERATIONS_EXTEND_EXTENDOPERATION_H_
...
#endif /* LOCALSEARCH_OPERATIONS_EXTEND_EXTENDOPERATION_H_ */
